   ...
   <div class="page-inner py-5">
      <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
         ...
         <div class="ml-md-auto py-2 py-md-0">
            <a href="<?= base_url('admin/daftar_user') ?>" class="btn btn-white btn-border btn-round mr-2">Manage</a>
            <a href="<?= base_url('admin/tambah_user') ?>" class="btn btn-primary btn-round">Add User</a>
         </div>
      </div>
   </div>
</div>
<div class="page-inner mt--5">
   <div class="row mt--2">
      <div class="col-md-7">
         <div class="card">
            <div class="card-body p-3">
               <div class="card-title pb-3">Statistik User</div>
               <div class="row text-center">
                  ...
                  <div class="col-4">
                     <div class="h1 m-0"><?= $total_user ?></div>
                     <div class="text-muted mb-3">Total user</div>
                  </div>
               </div>
            </div>
         </div>
         <div class="card">
            <div class="card-header">
               <div class="card-head-row">
                  <div class="card-title">Statistik User dalam 1 Tahun</div>
               </div>
            </div>
            <div class="card-body">
      ...
      <div class="col-md-5">
         <div class="card">
            <div class="card-body">
               <div class="card-title">Statistik User dalam 1 Minggu</div>
               <div class="row py-3">
                  <div class="col-12 d-flex ">
                     <div>
                        <h6 class="fw-bold text-uppercase text-success op-8">Total user</h6>
         ...
         <div class="card">
            <div class="card-body">
               <div class="card-title fw-mediumbold">New User today</div>
               <div class="card-list">
                  <?php
                  if ($user_today == []) :
                  ?>
