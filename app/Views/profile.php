               ...
               <div class="card-body">
                  <div class="row">
                     ...
                     <div class="form-group col-lg-6">
                        ...
                        <input type="text" name="no_hp" class="form-control" id="no-hp" value="<?= session()->no_hp ?>" placeholder="08312xxxx">
                     </div>
                     <div class="form-group col-lg-6">
                        <label for="alamat">Alamat</label>
                        <input type="text" name="alamat" class="form-control" id="alamat" value="<?= session()->alamat ?>" placeholder="Jl. Ahmad Yani">
                     </div>
                     <div class="form-group col-lg-6">
